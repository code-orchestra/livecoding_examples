package feathers.themes{
  ...
  public class MetalWorksMobileTheme extends DisplayListWatcher {
    ...
    protected static const AZURE_ATLAS_IMAGE : Class ;
    [Embed(source="../../assets/images/azure.xml", mimeType="application/octet-stream")]
    protected static const AZURE_ATLAS_XML : Class ;
    ...
    protected function simpleButtonInitializer ( button : Button ) : void {
      ...
      skinSelector.imageProperties = {width:60 * this.scale, height:60 * this.scale, textureScale:this.scale}
    ...
    protected function buttonGroupButtonInitializer ( button : Button ) : void {
      ...
      skinSelector.setValueForState(this.buttonDisabledSkinTextures, Button.STATE_DISABLED, false);
      skinSelector.setValueForState(this.buttonSelectedDisabledSkinTextures, Button.STATE_DISABLED, true);
      skinSelector.imageProperties = {width:76 * this.scale, height:76 * this.scale, textureScale:this.scale}
      button.stateToSkinFunction = skinSelector.updateValue;
    ...
    protected function toggleSwitchTrackInitializer ( track : Button ) : void {
      ...
      skinSelector.imageProperties = {width:150 * this.scale, height:60 * this.scale, textureScale:this.scale}
    ...
    protected function sliderTrackInitializer ( track : Button ) : void {
      ...
      skinSelector.setValueForState(this.buttonDownSkinTextures, Button.STATE_DOWN, false);
      skinSelector.setValueForState(this.backgroundDisabledSkinTextures, Button.STATE_DISABLED, false);
      skinSelector.imageProperties = {textureScale:this.scale};
      track.stateToSkinFunction = skinSelector.updateValue;
    }
    ...
    protected function itemRendererInitializer ( renderer : BaseDefaultItemRenderer ) : void {
      ...
      skinSelector.imageProperties = {width:88 * this.scale, height:88 * this.scale, textureScale:this.scale}
    ...
    protected function radioInitializer ( radio : Radio ) : void {
      ...
      iconSelector.imageProperties = {scaleX:this.scale, scaleY:this.scale}
    ...
    protected function pageIndicatorInitializer ( pageIndicator : PageIndicator ) : void {
      ...
      pageIndicator.paddingTop = pageIndicator.paddingRight = pageIndicator.paddingBottom = pageIndicator.paddingLeft = 6 * this.scale;
    ...
    protected function pickerListInitializer ( list : PickerList ) : void {
      ...
      if ( DeviceCapabilities.isTablet(Starling.current.nativeStage) ) {
        ...
        list.listProperties.paddingTop = list.listProperties.paddingRight = list.listProperties.paddingBottom = list.listProperties.paddingLeft = 8 * this.scale;
      }
    ...
    protected function calloutInitializer ( callout : Callout ) : void {
      ...
      callout.paddingTop = callout.paddingRight = callout.paddingBottom = callout.paddingLeft = 8 * this.scale;
    }
    ...
    protected function insetGroupedListInitializer ( list : GroupedList ) : void {
      ...
      const layout : VerticalLayout  = new VerticalLayout();
      layout.useVirtualLayout = true;
      layout.paddingTop = layout.paddingRight = layout.paddingBottom = layout.paddingLeft = 18 * this.scale;
      layout.gap = 0;
      layout.horizontalAlign = VerticalLayout.HORIZONTAL_ALIGN_JUSTIFY;
