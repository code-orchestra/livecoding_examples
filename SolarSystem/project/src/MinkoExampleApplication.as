package
{
	...
	public class MinkoExampleApplication extends Sprite
	{
		...
		public /*private*/ var _scene				: Scene				= new Scene();
		
		private var _cursor				: Point				= new Point();
		
		public /*protected*/ function get viewport() : Viewport
		{
			return _viewport;
		}
		
		public /*protected*/ function get camera() : Camera
		{
			return _camera;
		}
		
		public /*protected*/ function get cameraController() : ArcBallController
		{
			return _cameraController;
		}
		
		public /*protected*/ function get scene() : Scene
		{
			return _scene;
		}
